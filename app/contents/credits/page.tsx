...
const credits = () => {
  return (
    <motion.div
      ...
      className={`items-center flex flex-col ${ArimoFont.className}`}
    >
      <div className="md:w-[800px] m-4 w-[370px] gap-4 flex flex-col items-center">
        <h1
        ...
        <p className="mb-2 text-lg dark:text-neutral-400">
          ...
          independently by{" "}
          <span className="text-red-600 hover:text-red-400">Ray Zhao</span> in
          Feb 2025 and is completely open source.
        </p>
        <h1
          className={`${crimsonFont.className} text-2xl border-b-2 border-b-red-600 mr-auto dark:text-neutral-300`}
        >
        ...
        <p
          className={`text-2xl ${crimsonFont.className} dark:text-neutral-400 mt-4`}
        >
