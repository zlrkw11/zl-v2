...
const Blogs = async () => {
  ...
  return (
    <div
      className={`flex flex-col md:w-[800px] max-w-[420px] items-center gap-4 text-gray-700`}
    >
      ...
      <p
        className={`mb-2 md:min-w-[700px] m-2 text-sm md:text-base max-w-[350px] ${ArimoFont.className} `}
      >
      ...
      <ul className={`gap-2 flex flex-col ${ArimoFont.className}`}>
        {blogs.map((blog: any) => (
          <li
            key={blog.slug}
            className="p-2 md:min-w-[700px] max-w-[420px] border-2 border-l-red-600"
          >
